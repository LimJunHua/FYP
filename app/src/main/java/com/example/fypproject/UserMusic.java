...
public class UserMusic extends AppCompatActivity {
    ...
    boolean checkPermission(){
        int result = ContextCompat.checkSelfPermission(UserMusic.this, Manifest.permission.READ_EXTERNAL_STORAGE);
    ...
    void requestPermission(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(UserMusic.this,Manifest.permission.READ_EXTERNAL_STORAGE)){
            Toast.makeText(UserMusic.this,"READ PERMISSION IS REQUIRED,PLEASE ALLOW FROM SETTTINGS",Toast.LENGTH_SHORT).show();
        }else
            ActivityCompat.requestPermissions(UserMusic.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},123);
    }
